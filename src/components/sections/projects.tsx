...
const projects: Project[] = [
  {
    ...
    whatJJDid: "Built a custom WordPress multisite with nested \"sub-adventures\" content feature. Set up a GitHub → Coolify → Cloudflare Tunnel deployment pipeline. Collaborated with a second developer using shared GitHub workflows as a two-person team. Generated custom branding assets using ComfyUI with the Z-Image Turbo model.",
  ...
  },
  {
    ...
    whatJJDid: "Administer an Unraid server hosting Coolify, Homepage dashboard, Nextcloud, and multiple containerized services on a ZFS storage pool. Diagnosed and resolved Docker named-volume caching issues. Troubleshot KVM/libvirt VM startup failures tied to loop-device conflicts. Exposed self-hosted services to the public internet securely via Cloudflare Tunnels, avoiding open inbound ports.",
  ...
  },
  {
    ...
    whatJJDid: "Configured Ollama on a Windows workstation (RTX 5060, 8GB VRAM) for local model inference. Diagnosed and fixed a Cline tool-call failure/looping issue caused by Ollama's default context window, resolving it with a custom Modelfile raising num_ctx to 8192–16384. Explored a broader local-AI stack including Open WebUI, AnythingLLM (RAG), n8n automation, and Whisper transcription. Evaluated and integrated OpenCode as a CLI-based coding agent.",
    result: "A fully functional local AI development stack enabling private, fast AI-assisted coding.",
    techStack: ["Ollama", "RTX 5060", "Cline", "OpenCode", "Open WebUI"],
    featured: true,
  },
  {
